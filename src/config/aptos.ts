...
export const FUNCTIONS = {
  ...
  GET_MEMBER_BALANCE_IN_GROUP: `${CONTRACT_ADDRESS}::${MODULE_NAME}::get_member_balance_in_group`,
  GET_COUNTERPARTIES: `${CONTRACT_ADDRESS}::${MODULE_NAME}::get_counterparties`,
